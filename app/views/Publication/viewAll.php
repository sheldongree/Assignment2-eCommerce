<?php foreach ($publications as $publication): ?>
    <div>
        ...
        <?php if (isset($_SESSION['profile_id']) && $publication->profile_id === $_SESSION['profile_id']): ?>
            ...
            <a href="/Publication/editPublication/<?php echo $publication->publication_id; ?>">Edit</a>
            <a href="/Publication/deletePublication/<?php echo $publication->publication_id; ?>">Delete</a>
        <?php endif; ?>
    </div>
<?php endforeach; ?>