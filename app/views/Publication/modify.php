...
<body>
    ...
    <form action="/Publication/modify/<?php echo $publication->publication_id; ?>" method="post">
        ...
        <input type="text" id="publication_title" name="publication_title" value="<?php echo $publication->publication_title; ?>"><br><br>

        <label for="publication_text">Text:</label><br>
        <textarea id="publication_text" name="publication_text"><?php echo $publication->publication_text; ?></textarea><br><br>
